...
في هذا الفصل، التعلم عن كيفية تعامل المؤلف مع نظام المجلات المفتوحة بدءً من التسجيل وانتهاءً بالقراءة التصحيحية للوح الطباعي النهائي.

## التسجيل في المجلة

لتقديم طلب نشر إلى مجلة تعمل بنظام المجلات المفتوحة، عليك أولاً التسجيل بمثابة مؤلف \(أنظر [التسجيل في مجلة](./registering_with_a_journal.md)\). بعد ذلك وعند تسجيل الدخول في الموقع، سيتم أخذك إلى لوحة القيادة.

![](./assets/learning-ojs3.1-au-dashboard-empty.PNG)

وهي حالياً خالية حيث انك لم تقدم أي طلبات بعد.

<hr />

## تقديم مقالة

إبدأ بتقديم طلب جديد عبر النقر على زر **طلب جديد** في الجانب الأيسر من النافذة.  سيتم أخذك إلى الخطوة الأولى من عملية تستغرق خمس خطوات لرفع وتوصيف طلبك.
...
بمجرد إكمال رفع كل ملفاتك، أنقر **إكمال**؛ هذا سيغلق نافذة الرفع.

![](./assets/learning-ojs-3-author-submission-step2-4.png)

ستتم إعادتك إلى نافذة _تقديم مقالة_ حيث ستعاين الملفات التي سبق لك رفعها. إذا أردت إجراء تعديلات، قم بتوسيع السهم الأزرق في يسار الملف المعني وأجر أي تعديلات مستعملاً رابط _تعديل_.
...
ستظهر نافذة منبثقة تطالبك بتأكيد رغبتك في إنهاء التقديم. أنقر **تم**.
...
إذا كان لديك أي ملفات إضافية لرفعها، إرفعها الآن، وإلا، أنقر **إكمال**.
...
إستعمل رابط *إضافة مستخدم* لإضافة المحرر.
...
إرفع الملف الجديد في مقطع التحكيمات. للقيام بذلك، أنقر على ‘رفع ملف.’ ستظهر لك نافذة جديدة تتيح رفع ملف/ملفات. إختر من القائمة المنسدلة ما تراه مناسباً للإشارة إلى أنك ترفع نسخة معدلة من ملف موجود سابقاً.
...
إذا تطلب الأمر، يمكنك إرفاق نسخة منقحة، ولكن سنقتصر هنا على أنك قد وافقت على النتائج. أنقر **تم**.
